...
use crate::{PointCloudAssetData, PointCloudChunkRecord};
...
fn chunk_center(chunk: &PointCloudChunkRecord) -> Vec3 {
    Vec3::new(
...
mod tests {
    ...
    fn sample_asset(chunk_count: usize) -> PointCloudAssetData {
        ...
        PointCloudAssetData {
            version: 1,
            point_count: (chunk_count * 100) as u64,
