...
This repository is in **Beta (0.1.0-beta)**: open any project directory, export GLB snapshots, remote Copilot API key stub, and CI release artifacts on version tags.
