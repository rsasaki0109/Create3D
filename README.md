...
This repository is in **Beta (0.1.3-beta)**: open any project directory, export GLB/USD snapshots, remote Copilot LLM integration, live ROS2 sidecar bridge, and CI release artifacts on version tags.
